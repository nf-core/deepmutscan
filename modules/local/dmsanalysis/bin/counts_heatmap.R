...
counts_heatmap <- function(input_csv_path, threshold = 3, output_pdf_path, img_format = "pdf") {
  ...
  if (!"total_counts" %in% colnames(heatmap_data)) {
    stop("The column 'total_counts' is not found in the data.")
  }
