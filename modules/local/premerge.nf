...
process PREMERGE {
    ...
    container "community.wave.seqera.io/library/samtools_vsearch:8c029891fb10363b"
    // samtools & vsearch in container
    ...
    output:
    tuple val(meta), path("merged_reads.fastq"), emit: merged_reads
